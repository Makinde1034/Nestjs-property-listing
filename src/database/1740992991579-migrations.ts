...
export class Migrations1740992991579 implements MigrationInterface {
    name = 'Migrations1740992991579'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-03-03T09:09:53.584Z"'`);
