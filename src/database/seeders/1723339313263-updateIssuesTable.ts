...
export class UpdateIssuesTable1723339313263 implements MigrationInterface {
    name = 'UpdateIssuesTable1723339313263'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "issue_category" ALTER COLUMN "issueCategoryId" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "issue_category" ALTER COLUMN "issueCategoryId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "issue_category" ADD CONSTRAINT "FK_dd88320d851b90f554148abbdea" FOREIGN KEY ("issueCategoryId") REFERENCES "parent_issue"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
