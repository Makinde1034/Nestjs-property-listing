...
export class CreateOfferTable1717441291361 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD CONSTRAINT "PK_1fcad95cc01b37848c6794bbdd8" PRIMARY KEY ("roleId", "permissionId", "id")`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "PK_1fcad95cc01b37848c6794bbdd8"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD CONSTRAINT "PK_b817d7eca3b85f22130861259dd" PRIMARY KEY ("roleId", "permissionId")`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ALTER COLUMN "roleId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "PK_1fcad95cc01b37848c6794bbdd8"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD CONSTRAINT "PK_0a2ca94358c371e4ba5ffdb7b34" PRIMARY KEY ("permissionId", "id")`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ALTER COLUMN "permissionId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "PK_0a2ca94358c371e4ba5ffdb7b34"`);
        ...
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD CONSTRAINT "PK_1fcad95cc01b37848c6794bbdd8" PRIMARY KEY ("roleId", "id", "permissionId")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "PK_1fcad95cc01b37848c6794bbdd8"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD CONSTRAINT "PK_42d6ade159e994924085de23d1a" PRIMARY KEY ("roleId", "id")`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "PK_42d6ade159e994924085de23d1a"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD CONSTRAINT "PK_17022daf3f885f7d35423e9971e" PRIMARY KEY ("id")`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "PK_17022daf3f885f7d35423e9971e"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD CONSTRAINT "PK_0a2ca94358c371e4ba5ffdb7b34" PRIMARY KEY ("permissionId", "id")`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ALTER COLUMN "permissionId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "PK_0a2ca94358c371e4ba5ffdb7b34"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD CONSTRAINT "PK_1fcad95cc01b37848c6794bbdd8" PRIMARY KEY ("roleId", "permissionId", "id")`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ALTER COLUMN "roleId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "PK_b817d7eca3b85f22130861259dd"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD CONSTRAINT "PK_1fcad95cc01b37848c6794bbdd8" PRIMARY KEY ("roleId", "permissionId", "id")`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "PK_1fcad95cc01b37848c6794bbdd8"`);
