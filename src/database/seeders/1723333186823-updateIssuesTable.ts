...
export class UpdateIssuesTable1723333186823 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "issue_category" RENAME COLUMN "placement" TO "issueCategoryId"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "issue_category" DROP COLUMN "issueCategoryId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "issue_category" ADD "issueCategoryId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "issue_category" ADD CONSTRAINT "UQ_dd88320d851b90f554148abbdea" UNIQUE ("issueCategoryId")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "issue_category" ADD CONSTRAINT "FK_dd88320d851b90f554148abbdea" FOREIGN KEY ("issueCategoryId") REFERENCES "parent_issue"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "issue_category" DROP CONSTRAINT "FK_dd88320d851b90f554148abbdea"`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" DROP CONSTRAINT "FK_f2884b2e973bc39c7a2f4ecdf26"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "issue_category" DROP CONSTRAINT "UQ_dd88320d851b90f554148abbdea"`,
    );
    await queryRunner.query(
      `ALTER TABLE "issue_category" DROP COLUMN "issueCategoryId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "issue_category" ADD "issueCategoryId" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "issue_category" RENAME COLUMN "issueCategoryId" TO "placement"`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
