...
export class ApprovalTOworkflow1740993036047 implements MigrationInterface {
    name = 'ApprovalTOworkflow1740993036047'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "action_request" ADD "approval" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "action_request" ADD "currentApproval" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-03-03T09:10:38.093Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2025-02-27 10:43:12.086'`);
        await queryRunner.query(`ALTER TABLE "action_request" DROP COLUMN "currentApproval"`);
        await queryRunner.query(`ALTER TABLE "action_request" DROP COLUMN "approval"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
