...
export class UpdateGeneralLedger1735303176570 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "invoice" ADD "capturedPrice" numeric(10,2)`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice" ADD "reference" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-12-27T12:39:38.617Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-12-26 09:21:54.094'`,
    );
    await queryRunner.query(`ALTER TABLE "invoice" DROP COLUMN "reference"`);
    await queryRunner.query(
      `ALTER TABLE "invoice" DROP COLUMN "capturedPrice"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
