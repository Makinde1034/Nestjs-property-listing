...
export class UpdateIssueTable1720111990060 implements MigrationInterface {
  name = 'UpdateIssueTable1720111990060';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "issue" DROP COLUMN "categoryId"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "issue" ADD "category" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "issue" ADD "parentReason" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "issue" ADD "parentArabicName" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "issue" ADD "childReason" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "issue" ADD "childArabicName" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "issue" DROP COLUMN "childReason"`);
    await queryRunner.query(
      `ALTER TABLE "issue" DROP COLUMN "parentArabicName"`,
    );
    await queryRunner.query(`ALTER TABLE "issue" DROP COLUMN "parentReason"`);
    await queryRunner.query(`ALTER TABLE "issue" DROP COLUMN "category"`);
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "issue" ADD "categoryId" uuid`);
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
    await queryRunner.query(
