...
export class UpdateIssueTable1720112586288 implements MigrationInterface {
  name = 'UpdateIssueTable1720112586288';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "issue" ALTER COLUMN "message" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "issue" ALTER COLUMN "childArabicName" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "issue" ALTER COLUMN "childArabicName" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "issue" ALTER COLUMN "message" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
