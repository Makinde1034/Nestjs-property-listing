...
export class AddTitleAndPurposeImage1721737231357
  implements MigrationInterface
{
  name = 'AddTitleAndPurposeImage1721737231357';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "purpose" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "price" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "deedNumber" character varying`,
    );
    await queryRunner.query(
