...
export class CreateWishlistTable1719847273364 implements MigrationInterface {
  name = 'CreateWishlistTable1719847273364';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "wishlist" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid, CONSTRAINT "REL_f6eeb74a295e2aad03b76b0ba8" UNIQUE ("userId"), CONSTRAINT "PK_620bff4a240d66c357b5d820eaa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
