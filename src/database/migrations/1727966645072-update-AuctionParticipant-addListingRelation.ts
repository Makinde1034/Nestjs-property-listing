...
export class UpdateAuctionParticipantAddListingRelation1727966645072 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-03T14:44:06.496Z"'`);
        await queryRunner.query(`ALTER TABLE "auction_participant" DROP COLUMN "listingId"`);
        await queryRunner.query(`ALTER TABLE "auction_participant" ADD "listingId" uuid NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "auction_participant" DROP COLUMN "listingId"`);
        await queryRunner.query(`ALTER TABLE "auction_participant" ADD "listingId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-02 18:39:52.758'`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
