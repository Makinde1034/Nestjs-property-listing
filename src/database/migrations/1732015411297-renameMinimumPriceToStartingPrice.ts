...
export class RenameMinimumPriceToStartingPrice1732015411297
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "auction_participant" DROP COLUMN "startPrice"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "auction_participant" ADD "startingPrice" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-19T11:23:33.037Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-18 21:59:11.184'`,
    );
    await queryRunner.query(
      `ALTER TABLE "auction_participant" DROP COLUMN "startingPrice"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "auction_participant" ADD "startPrice" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
