...
export class AddDeleteDateColumnToListingTypeTable1723733759630
  implements MigrationInterface
{
  name = 'AddDeleteDateColumnToListingTypeTable1723733759630';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing_type" ADD "deletedAt" TIMESTAMP`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing_type" DROP COLUMN "deletedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
