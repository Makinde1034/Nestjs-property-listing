...
export class UpdateInvoiceChangeVatType1728498279276 implements MigrationInterface {
    name = 'UpdateInvoiceChangeVatType1728498279276'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "vat" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-09T18:24:40.751Z"'`);
        await queryRunner.query(`ALTER TABLE "invoice" DROP COLUMN "vat"`);
        await queryRunner.query(`ALTER TABLE "invoice" ADD "vat" numeric(10,2) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "invoice" DROP COLUMN "vat"`);
        await queryRunner.query(`ALTER TABLE "invoice" ADD "vat" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-09 08:07:20.221'`);
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "vat" SET DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
