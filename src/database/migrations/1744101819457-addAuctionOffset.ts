...
export class AddAuctionOffset1744101819457 implements MigrationInterface {
    name = 'AddAuctionOffset1744101819457'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "auction" ADD "expireOffset" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-04-08T08:43:41.447Z"'`);
        await queryRunner.query(`ALTER TABLE "auction_participant" ALTER COLUMN "status" SET NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_132e24cfd4c51a19cc7e270aa2" ON "auction" ("expireOffset") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_132e24cfd4c51a19cc7e270aa2"`);
        await queryRunner.query(`ALTER TABLE "auction_participant" ALTER COLUMN "status" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2025-03-28 20:54:07.28'`);
        await queryRunner.query(`ALTER TABLE "auction" DROP COLUMN "expireOffset"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
