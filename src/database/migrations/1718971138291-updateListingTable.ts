...
export class UpdateListingTable1718971138291 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "listing" ADD "rentedApartment" character varying`);
        await queryRunner.query(`ALTER TABLE "listing" ALTER COLUMN "rentingOption" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "listing" ALTER COLUMN "rentingOption" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "listing" DROP COLUMN "rentedApartment"`);
