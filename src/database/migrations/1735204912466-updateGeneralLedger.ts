...
export class UpdateGeneralLedger1735204912466 implements MigrationInterface {
    name = 'UpdateGeneralLedger1735204912466'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "general_ledger" DROP COLUMN "accountNumber"`);
        await queryRunner.query(`ALTER TABLE "general_ledger" DROP COLUMN "offerId"`);
        await queryRunner.query(`ALTER TABLE "general_ledger" DROP COLUMN "status"`);
        await queryRunner.query(`ALTER TABLE "general_ledger" DROP COLUMN "reference"`);
        await queryRunner.query(`ALTER TABLE "general_ledger" DROP COLUMN "saiiFee"`);
        ...
        await queryRunner.query(`ALTER TABLE "general_ledger" ADD "referenceId" character varying(50) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-12-26T09:21:54.094Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-12-24 13:24:26.13'`);
        await queryRunner.query(`ALTER TABLE "general_ledger" DROP COLUMN "referenceId"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "general_ledger" ADD "saiiFee" numeric(12,2) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "general_ledger" ADD "reference" character varying(50) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "general_ledger" ADD "status" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "general_ledger" ADD "offerId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "general_ledger" ADD "accountNumber" character varying(100) NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b36cb2e04bc353ca4ede00d87b" ON "role_permissions_permission" ("roleId") `);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD CONSTRAINT "FK_b36cb2e04bc353ca4ede00d87b9" FOREIGN KEY ("roleId") REFERENCES "role"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD CONSTRAINT "FK_bfbc9e263d4cea6d7a8c9eb3ad2" FOREIGN KEY ("permissionId") REFERENCES "permission"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
