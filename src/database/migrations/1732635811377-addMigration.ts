...
export class AddMigration1732635811377 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "notification" ADD "directToWeb" boolean`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification" ADD "directToMobile" boolean`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-26T15:43:33.123Z"'`,
    );
    await queryRunner.query(
      `ALTER TABLE "work_flow" ALTER COLUMN "approvalTwoRole" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "work_flow" ALTER COLUMN "approvalTwoRole" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-25 16:43:38.49'`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification" DROP COLUMN "directToMobile"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification" DROP COLUMN "directToWeb"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
