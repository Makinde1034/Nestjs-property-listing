...
export class AddMigration1732635811377 implements MigrationInterface {
    name = 'AddMigration1732635811377'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "notification" ADD "directToWeb" boolean`);
        await queryRunner.query(`ALTER TABLE "notification" ADD "directToMobile" boolean`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-26T15:43:33.123Z"'`);
        await queryRunner.query(`ALTER TABLE "work_flow" ALTER COLUMN "approvalTwoRole" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "work_flow" ALTER COLUMN "approvalTwoRole" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-25 16:43:38.49'`);
        await queryRunner.query(`ALTER TABLE "notification" DROP COLUMN "directToMobile"`);
        await queryRunner.query(`ALTER TABLE "notification" DROP COLUMN "directToWeb"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
