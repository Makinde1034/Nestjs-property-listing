...
export class AddsColumnArabicNameToListingType1722236807357
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing_type" ADD "englishName" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing_type" ADD "arabicName" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing_type" DROP COLUMN "arabicName"`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing_type" DROP COLUMN "englishName"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "listing_type" ADD "name" character varying NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
