...
export class CreateInvoiceTable1721967345389 implements MigrationInterface {
    name = 'CreateInvoiceTable1721967345389'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "invoice" ADD "price" numeric(10,2) NOT NULL`);
