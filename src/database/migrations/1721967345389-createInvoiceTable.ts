...
export class CreateInvoiceTable1721967345389 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "offer" RENAME COLUMN "offerPrice" TO "price"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "offer" ADD "price" numeric(10,2) NOT NULL DEFAULT '1300'`,
    );
    await queryRunner.query(`ALTER TABLE "invoice" DROP COLUMN "price"`);
    await queryRunner.query(
      `ALTER TABLE "invoice" ADD "price" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "invoice" DROP COLUMN "price"`);
    await queryRunner.query(
      `ALTER TABLE "invoice" ADD "price" integer NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "offer" DROP COLUMN "price"`);
    ...
    await queryRunner.query(
      `ALTER TABLE "offer" RENAME COLUMN "price" TO "offerPrice"`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
