...
export class UpdateChangeThePriceTypeOfListing1721122044611 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "search_history" ADD "price" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "listing" DROP COLUMN "price"`);
        await queryRunner.query(`ALTER TABLE "listing" ADD "price" integer NOT NULL DEFAULT '2000'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "search_history" DROP COLUMN "price"`);
        await queryRunner.query(`ALTER TABLE "search_history" ADD "price" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b36cb2e04bc353ca4ede00d87b" ON "role_permissions_permission" ("roleId") `);
