...
export class AddUserToFlaglistingTable1725693246869
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "flag_listing" ADD "userId" uuid NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "flag_listing" ADD CONSTRAINT "FK_6d9a483e681fcce91f781dc6cc7" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "flag_listing" DROP CONSTRAINT "FK_6d9a483e681fcce91f781dc6cc7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "FK_bfbc9e263d4cea6d7a8c9eb3ad2"`,
    );
    ...
    await queryRunner.query(`ALTER TABLE "flag_listing" DROP COLUMN "userId"`);
    await queryRunner.query(
      `ALTER TABLE "flag_listing" ADD "userId" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
