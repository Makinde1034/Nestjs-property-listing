...
export class UpdateListingAttributes1723464887059
  implements MigrationInterface
{
  name = 'UpdateListingAttributes1723464887059';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute" ALTER COLUMN "filterIndex" SET DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" ALTER COLUMN "summaryIndex" SET DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" ALTER COLUMN "createListingIndex" SET DEFAULT '0'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute" ALTER COLUMN "createListingIndex" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" ALTER COLUMN "summaryIndex" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" ALTER COLUMN "filterIndex" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
