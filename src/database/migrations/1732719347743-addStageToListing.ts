...
export class AddStageToListing1732719347743 implements MigrationInterface {
  name = 'AddStageToListing1732719347743';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "activity_log" ADD "placement" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "stage" character varying NOT NULL DEFAULT 'Listed '`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-27T14:55:49.619Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-26 15:43:33.123'`,
    );
    await queryRunner.query(`ALTER TABLE "listing" DROP COLUMN "stage"`);
    await queryRunner.query(
      `ALTER TABLE "activity_log" DROP COLUMN "placement"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
