...
export class UpdateListingTable1718186816857 implements MigrationInterface {
  name = 'UpdateListingTable1718186816857';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" RENAME COLUMN "numberOFRentedAppartment" TO "rentedAppartment"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" RENAME COLUMN "rentedAppartment" TO "numberOFRentedAppartment"`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
