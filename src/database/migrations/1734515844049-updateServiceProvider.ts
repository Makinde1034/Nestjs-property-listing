...
export class UpdateServiceProvider1734515844049 implements MigrationInterface {
  name = 'UpdateServiceProvider1734515844049';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_provider" ADD "reason" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-12-18T09:57:25.938Z"'`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ALTER COLUMN "published" SET DEFAULT false`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5ec8555dc8f2eea13c15cd7e55" ON "ticket" ("assignedAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5f099baafb6f88454b6a7b28b8" ON "service_provider" ("userId") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5f099baafb6f88454b6a7b28b8"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5ec8555dc8f2eea13c15cd7e55"`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ALTER COLUMN "published" SET DEFAULT true`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-12-12 07:45:35.602'`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider" DROP COLUMN "reason"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
