...
export class CreateInvoiceTable1721940196635 implements MigrationInterface {
    name = 'CreateInvoiceTable1721940196635'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "invoice" ("id" SERIAL NOT NULL, "price" integer NOT NULL, "userId" character varying NOT NULL, "listingid" character varying NOT NULL, "expireAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_15d25c200d9bcd8a33f698daf18" PRIMARY KEY ("id"))`);
