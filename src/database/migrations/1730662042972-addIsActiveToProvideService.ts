...
export class AddIsActiveToProvideService1730662042972
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_status" DROP COLUMN "servicePrividerId"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "service_status" ADD "isActive" boolean NOT NULL DEFAULT true`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-03T19:27:24.526Z"'`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_status" DROP COLUMN "serviceProviderId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_status" ADD "serviceProviderId" uuid NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "service_status" ADD CONSTRAINT "FK_a9364c595ea78c1d16293317130" FOREIGN KEY ("serviceProviderId") REFERENCES "service_provider"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "service_status" DROP CONSTRAINT "FK_a9364c595ea78c1d16293317130"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "FK_bfbc9e263d4cea6d7a8c9eb3ad2"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "service_status" ADD "serviceProviderId" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-03 16:11:54.164'`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_status" DROP COLUMN "isActive"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "service_status" ADD "servicePrividerId" uuid`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
