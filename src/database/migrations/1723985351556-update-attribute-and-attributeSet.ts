...
export class UpdateAttributeAndAttributeSet1723985351556
  implements MigrationInterface
{
  name = 'UpdateAttributeAndAttributeSet1723985351556';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute" ADD "deletedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute_set" ADD "deletedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
