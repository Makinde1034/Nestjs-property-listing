...
export class UpdateTicketAddDefauleValueToUpdatedAt1727161520829 implements MigrationInterface {
    name = 'UpdateTicketAddDefauleValueToUpdatedAt1727161520829'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-09-24T07:05:22.296Z"'`);
