...
export class UppdateServiceStatus1731062465000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-08T10:41:06.449Z"'`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_status" DROP CONSTRAINT "FK_e7333093680d7a8140964cb027e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_status" DROP CONSTRAINT "REL_e7333093680d7a8140964cb027"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_status" ADD CONSTRAINT "REL_e7333093680d7a8140964cb027" UNIQUE ("serviceId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_status" ADD CONSTRAINT "FK_e7333093680d7a8140964cb027e" FOREIGN KEY ("serviceId") REFERENCES "service"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-07 17:14:17.119'`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
