...
export class ChangeStatusOfAuctionTable1725542129581
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "auction" ADD "status" character varying NOT NULL DEFAULT 'inactive'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "auction" DROP COLUMN "status"`);
    await queryRunner.query(
      `ALTER TABLE "auction" ADD "status" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
