...
export class UpdatefeatureTable1724081072639 implements MigrationInterface {
  name = 'UpdatefeatureTable1724081072639';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "feature" DROP COLUMN "expiredAt"`);
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "feature" ADD "endDate" TIMESTAMP`);
    await queryRunner.query(`ALTER TABLE "feature" ADD "startDate" TIMESTAMP`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "feature" DROP COLUMN "startDate"`);
    await queryRunner.query(`ALTER TABLE "feature" DROP COLUMN "endDate"`);
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "feature" ADD "expiredAt" TIMESTAMP`);
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
    await queryRunner.query(
