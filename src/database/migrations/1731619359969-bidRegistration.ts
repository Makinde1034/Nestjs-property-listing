...
export class BidRegistration1731619359969 implements MigrationInterface {
  name = 'BidRegistration1731619359969';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "bid_registration" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "autoBid" boolean NOT NULL, "userId" character varying NOT NULL, "auctionId" character varying NOT NULL, "listingId" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_539295cd014e1523124b9dd2983" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_539295cd014e1523124b9dd298" ON "bid_registration" ("id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-14T21:22:41.999Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-14 11:55:16.448'`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_539295cd014e1523124b9dd298"`,
    );
    await queryRunner.query(`DROP TABLE "bid_registration"`);
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
    await queryRunner.query(
