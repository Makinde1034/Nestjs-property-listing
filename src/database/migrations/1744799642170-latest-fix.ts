...
export class LatestFix1744799642170 implements MigrationInterface {
    name = 'LatestFix1744799642170'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-04-16T10:34:06.826Z"'`);
