...
export class AdEventToNotificationMessage1731921601437
  implements MigrationInterface
{
  name = 'AdEventToNotificationMessage1731921601437';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-18T09:20:02.776Z"'`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification_messages" ALTER COLUMN "event" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "notification_messages" ALTER COLUMN "event" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-18 09:13:42.78'`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
