...
export class AddAttachmentMessageTable1725461659553 implements MigrationInterface {
    name = 'AddAttachmentMessageTable1725461659553'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "messages" ADD "attachment" character varying`);
