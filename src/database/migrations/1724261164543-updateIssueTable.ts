...
export class UpdateIssueTable1724261164543 implements MigrationInterface {
  name = 'UpdateIssueTable1724261164543';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "parent_issue" RENAME COLUMN "issueCategoryId" TO "placement"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "parent_issue" DROP COLUMN "placement"`,
    );
    await queryRunner.query(
      `ALTER TABLE "parent_issue" ADD "placement" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "parent_issue" ADD "placement" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "parent_issue" RENAME COLUMN "placement" TO "issueCategoryId"`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
