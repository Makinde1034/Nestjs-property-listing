...
export class UpdateUser1730876032837 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_53c5b5fa1f4ac75c6c200d7cb6" ON "work_flow" ("id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-06T06:53:54.194Z"'`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ALTER COLUMN "currentTermOfservice" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "accepted_terms" DROP COLUMN "userId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "accepted_terms" ADD "userId" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "accepted_terms" ADD "userId" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ALTER COLUMN "currentTermOfservice" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-05 15:28:42.587'`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_53c5b5fa1f4ac75c6c200d7cb6"`,
    );
