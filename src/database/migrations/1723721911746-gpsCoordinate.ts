...
export class GpsCoordinate1723721911746 implements MigrationInterface {
    name = 'GpsCoordinate1723721911746'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "gps_coordinate" DROP COLUMN "lat"`);
        await queryRunner.query(`ALTER TABLE "gps_coordinate" ADD "lat" double precision NOT NULL`);
        await queryRunner.query(`ALTER TABLE "gps_coordinate" DROP COLUMN "lng"`);
        await queryRunner.query(`ALTER TABLE "gps_coordinate" ADD "lng" double precision NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "gps_coordinate" DROP COLUMN "lng"`);
        await queryRunner.query(`ALTER TABLE "gps_coordinate" ADD "lng" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "gps_coordinate" DROP COLUMN "lat"`);
        await queryRunner.query(`ALTER TABLE "gps_coordinate" ADD "lat" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b36cb2e04bc353ca4ede00d87b" ON "role_permissions_permission" ("roleId") `);
