...
export class GpsCoordinate1723721911746 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "gps_coordinate" ADD "lat" double precision NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "gps_coordinate" DROP COLUMN "lng"`);
    await queryRunner.query(
      `ALTER TABLE "gps_coordinate" ADD "lng" double precision NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "gps_coordinate" DROP COLUMN "lng"`);
    await queryRunner.query(
      `ALTER TABLE "gps_coordinate" ADD "lng" integer NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "gps_coordinate" DROP COLUMN "lat"`);
    await queryRunner.query(
      `ALTER TABLE "gps_coordinate" ADD "lat" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
