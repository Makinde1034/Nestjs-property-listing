...
export class UpdateListingTable1718194552126 implements MigrationInterface {
  name = 'UpdateListingTable1718194552126';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" RENAME COLUMN "numberOfBedrooms" TO "numberOfRooms"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" RENAME COLUMN "numberOfRooms" TO "numberOfBedrooms"`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
