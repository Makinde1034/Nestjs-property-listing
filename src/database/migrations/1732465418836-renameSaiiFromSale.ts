...
export class RenameSaiiFromSale1732465418836 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_default" RENAME COLUMN "saiiFromSale" TO "saiiForSale"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "activity_log" ADD "couponId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-24T16:23:40.260Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-23 17:02:21.026'`,
    );
    await queryRunner.query(
      `ALTER TABLE "activity_log" DROP COLUMN "couponId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_default" RENAME COLUMN "saiiForSale" TO "saiiFromSale"`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
