...
export class UpdateListingTable1720779341247 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "search_history" ADD "numberOfBathrooms" text NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "search_history" DROP COLUMN "numberOfRooms"`,
    );
    await queryRunner.query(
      `ALTER TABLE "search_history" ADD "numberOfRooms" text NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "search_history" ADD "numberOfRooms" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "search_history" DROP COLUMN "numberOfBathrooms"`,
    );
    await queryRunner.query(
      `ALTER TABLE "search_history" ADD "numberOfBathrooms" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
