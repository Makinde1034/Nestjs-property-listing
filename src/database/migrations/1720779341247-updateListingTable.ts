...
export class UpdateListingTable1720779341247 implements MigrationInterface {
    name = 'UpdateListingTable1720779341247'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "search_history" ADD "numberOfBathrooms" text NOT NULL`);
        await queryRunner.query(`ALTER TABLE "search_history" DROP COLUMN "numberOfRooms"`);
        await queryRunner.query(`ALTER TABLE "search_history" ADD "numberOfRooms" text NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "search_history" DROP COLUMN "numberOfRooms"`);
        await queryRunner.query(`ALTER TABLE "search_history" ADD "numberOfRooms" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "search_history" DROP COLUMN "numberOfBathrooms"`);
        await queryRunner.query(`ALTER TABLE "search_history" ADD "numberOfBathrooms" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b36cb2e04bc353ca4ede00d87b" ON "role_permissions_permission" ("roleId") `);
