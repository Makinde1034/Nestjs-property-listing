...
export class UpdateArticle1739359003445 implements MigrationInterface {
    name = 'UpdateArticle1739359003445'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-02-12T11:16:46.861Z"'`);
