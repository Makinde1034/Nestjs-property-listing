...
export class AddMerchantIdAndPaymentTypeToAdminDefault1729439657148
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_default" ADD "paymentType" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" ADD "merchantTransactionId" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-20T15:54:18.652Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-18 18:49:43.01'`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" DROP COLUMN "merchantTransactionId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" DROP COLUMN "paymentType"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
