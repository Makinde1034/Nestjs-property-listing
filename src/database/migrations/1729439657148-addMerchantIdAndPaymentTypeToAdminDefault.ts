...
export class AddMerchantIdAndPaymentTypeToAdminDefault1729439657148 implements MigrationInterface {
    name = 'AddMerchantIdAndPaymentTypeToAdminDefault1729439657148'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "paymentType" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "merchantTransactionId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-20T15:54:18.652Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-18 18:49:43.01'`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "merchantTransactionId"`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "paymentType"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
