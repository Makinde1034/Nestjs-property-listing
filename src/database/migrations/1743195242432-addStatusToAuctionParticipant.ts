...
export class AddStatusToAuctionParticipant1743195242432 implements MigrationInterface {
    name = 'AddStatusToAuctionParticipant1743195242432'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bids" ADD "bidderNumber" character varying`);
        await queryRunner.query(`ALTER TABLE "auction_participant" ADD "status" character varying`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-03-28T20:54:07.280Z"'`);
        await queryRunner.query(`ALTER TABLE "bids" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "bids" ADD "userId" uuid`);
        await queryRunner.query(`ALTER TABLE "bids" ALTER COLUMN "bidNumber" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "bids" ADD CONSTRAINT "FK_1531393fadbf123f3d51c91d819" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "bids" ALTER COLUMN "bidNumber" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "bids" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "bids" ADD "userId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2025-03-24 07:38:45.766'`);
        await queryRunner.query(`ALTER TABLE "auction_participant" DROP COLUMN "status"`);
        await queryRunner.query(`ALTER TABLE "bids" DROP COLUMN "bidderNumber"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
