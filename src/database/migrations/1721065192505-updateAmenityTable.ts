...
export class UpdateAmenityTable1721065192505 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute" ALTER COLUMN "isRequired" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" ALTER COLUMN "isAmenity" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute" ALTER COLUMN "isAmenity" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" ALTER COLUMN "isRequired" SET NOT NULL`,
    );
    await queryRunner.query(
