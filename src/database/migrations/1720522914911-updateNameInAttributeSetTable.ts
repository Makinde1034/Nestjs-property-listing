...
export class UpdateNameInAttributeSetTable1720522914911
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute" ADD "englishName" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" ADD "arabicName" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute_set" ADD "arabicName" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute_set" ADD "englishName" character varying`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute_set" DROP COLUMN "englishName"`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute_set" DROP COLUMN "arabicName"`,
    );
    await queryRunner.query(`ALTER TABLE "attribute" DROP COLUMN "arabicName"`);
    await queryRunner.query(
      `ALTER TABLE "attribute" DROP COLUMN "englishName"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute_set" ADD "name" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" ADD "name" character varying NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
