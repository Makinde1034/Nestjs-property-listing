...
export class RenameColumnInListingTabel1720102989574
  implements MigrationInterface
{
  name = 'RenameColumnInListingTabel1720102989574';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" RENAME COLUMN "IsListingPromoted" TO "isListingPromoted"`,
    );
    await queryRunner.query(
