...
export class CreateAdPackage1718299849825 implements MigrationInterface {
    name = 'CreateAdPackage1718299849825'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "listing" RENAME COLUMN "PromotionExpiration" TO "promotionExpiration"`);
