...
export class UpdateRoleTableToAddDeletedAt1724949125392
  implements MigrationInterface
{
  name = 'UpdateRoleTableToAddDeletedAt1724949125392';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "role" ADD "isDisabled" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
