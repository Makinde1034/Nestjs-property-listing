...
export class AddTitleAndPurposeImage1721738865833
  implements MigrationInterface
{
  name = 'AddTitleAndPurposeImage1721738865833';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "attribute" ADD "isAddress" boolean`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "attribute" DROP COLUMN "isAddress"`);
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
    await queryRunner.query(
