...
export class UpdateListingTable1721318053305 implements MigrationInterface {
  name = 'UpdateListingTable1721318053305';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" RENAME COLUMN "powerOfAttorney" TO "poaNumber"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" RENAME COLUMN "poaNumber" TO "powerOfAttorney"`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
