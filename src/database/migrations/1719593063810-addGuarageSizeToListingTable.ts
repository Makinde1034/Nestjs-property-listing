...
export class AddGuarageSizeToListingTable1719593063810 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "listing" ADD "garageSize" character varying`);
