...
export class AddDefaultValueForCurrentUse1733295216149
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-12-04T06:53:37.735Z"'`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ALTER COLUMN "stage" SET DEFAULT 'Listed'`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ALTER COLUMN "status" SET DEFAULT 'pending'`,
    );
    await queryRunner.query(
      `ALTER TABLE "coupon" ALTER COLUMN "currentUse" SET DEFAULT '0'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "coupon" ALTER COLUMN "currentUse" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ALTER COLUMN "status" SET DEFAULT 'Listed '`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ALTER COLUMN "stage" SET DEFAULT 'Listed '`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-28 11:36:00.259'`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
