...
export class AddDefaultValueForCurrentUse1733295216149 implements MigrationInterface {
    name = 'AddDefaultValueForCurrentUse1733295216149'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-12-04T06:53:37.735Z"'`);
        await queryRunner.query(`ALTER TABLE "listing" ALTER COLUMN "stage" SET DEFAULT 'Listed'`);
        await queryRunner.query(`ALTER TABLE "listing" ALTER COLUMN "status" SET DEFAULT 'pending'`);
        await queryRunner.query(`ALTER TABLE "coupon" ALTER COLUMN "currentUse" SET DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "coupon" ALTER COLUMN "currentUse" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "listing" ALTER COLUMN "status" SET DEFAULT 'Listed '`);
        await queryRunner.query(`ALTER TABLE "listing" ALTER COLUMN "stage" SET DEFAULT 'Listed '`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-28 11:36:00.259'`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
