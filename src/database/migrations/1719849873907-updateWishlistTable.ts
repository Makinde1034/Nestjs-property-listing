...
export class UpdateWishlistTable1719849873907 implements MigrationInterface {
  name = 'UpdateWishlistTable1719849873907';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "wishlist" ADD "deletedAt" TIMESTAMP`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "wishlist" DROP COLUMN "deletedAt"`);
