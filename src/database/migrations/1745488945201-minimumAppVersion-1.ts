...
export class MinimumAppVersion11745488945201 implements MigrationInterface {
    name = 'MinimumAppVersion11745488945201'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "minimumAppVersionIos" character varying`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "minimumAppVersionAndroid" character varying`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-04-24T10:02:30.888Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2025-04-16 10:34:06.826'`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "minimumAppVersionAndroid"`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "minimumAppVersionIos"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
