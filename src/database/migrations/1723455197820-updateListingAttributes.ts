...
export class UpdateListingAttributes1723455197820
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute" ADD "filterIndex" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" ADD "summaryIndex" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" ADD "createListingIndex" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" ADD "thiqaIntegration" text`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute" DROP COLUMN "thiqaIntegration"`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" DROP COLUMN "createListingIndex"`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" DROP COLUMN "summaryIndex"`,
    );
    await queryRunner.query(
      `ALTER TABLE "attribute" DROP COLUMN "filterIndex"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
