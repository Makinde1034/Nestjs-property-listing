...
export class CreateReviewTable1716223244228 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "review" ADD CONSTRAINT "FK_e4e523d7267d785e85a22a1c741" FOREIGN KEY ("service_owner_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "review" DROP CONSTRAINT "FK_e4e523d7267d785e85a22a1c741"`);
