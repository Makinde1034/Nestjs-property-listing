...
export class UpdateIssuesTable1723339745755 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "child_issue" ADD "childIssueId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "parent_issue" ADD "issueCategoryId" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "parent_issue" ADD CONSTRAINT "UQ_74a83153a72b3bdf17176dff72f" UNIQUE ("issueCategoryId")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "parent_issue" ADD CONSTRAINT "FK_74a83153a72b3bdf17176dff72f" FOREIGN KEY ("issueCategoryId") REFERENCES "issue_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "parent_issue" DROP CONSTRAINT "FK_74a83153a72b3bdf17176dff72f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "FK_bfbc9e263d4cea6d7a8c9eb3ad2"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "parent_issue" DROP CONSTRAINT "UQ_74a83153a72b3bdf17176dff72f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "parent_issue" DROP COLUMN "issueCategoryId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "child_issue" DROP COLUMN "childIssueId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
