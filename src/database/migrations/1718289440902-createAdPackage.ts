...
export class CreateAdPackage1718289440902 implements MigrationInterface {
  name = 'CreateAdPackage1718289440902';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "promotion" DROP COLUMN "impressions"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "listing" ADD "impressions" integer`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "listing" DROP COLUMN "impressions"`);
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "promotion" ADD "impressions" integer`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
