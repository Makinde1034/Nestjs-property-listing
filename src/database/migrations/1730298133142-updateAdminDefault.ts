...
export class UpdateAdminDefault1730298133142 implements MigrationInterface {
    name = 'UpdateAdminDefault1730298133142'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "dataRetention" integer`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "ratingPrompt" integer`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "ticketAging" integer`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "auctionHeldAmount" integer NOT NULL DEFAULT '100'`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "fallBackDefaultBidIncrement" integer NOT NULL DEFAULT '1000'`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-30T14:22:14.674Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-30 10:20:23.326'`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "fallBackDefaultBidIncrement"`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "auctionHeldAmount"`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "ticketAging"`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "ratingPrompt"`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "dataRetention"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
