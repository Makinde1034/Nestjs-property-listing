...
export class UpdateAdminDefault1730298133142 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_default" ADD "dataRetention" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" ADD "ratingPrompt" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" ADD "ticketAging" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" ADD "auctionHeldAmount" integer NOT NULL DEFAULT '100'`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" ADD "fallBackDefaultBidIncrement" integer NOT NULL DEFAULT '1000'`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-30T14:22:14.674Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-30 10:20:23.326'`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" DROP COLUMN "fallBackDefaultBidIncrement"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" DROP COLUMN "auctionHeldAmount"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" DROP COLUMN "ticketAging"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" DROP COLUMN "ratingPrompt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" DROP COLUMN "dataRetention"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
