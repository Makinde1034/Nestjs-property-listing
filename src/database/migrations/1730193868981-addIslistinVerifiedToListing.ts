...
export class AddIslistinVerifiedToListing1730193868981
  implements MigrationInterface
{
  name = 'AddIslistinVerifiedToListing1730193868981';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "isListingVerified" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-29T09:24:30.495Z"'`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c01c77fa37ef3666636c8b65ba" ON "listing" ("isListingVerified") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c01c77fa37ef3666636c8b65ba"`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-28 20:43:01.347'`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" DROP COLUMN "isListingVerified"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
