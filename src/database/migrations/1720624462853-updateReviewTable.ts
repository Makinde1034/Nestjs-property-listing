...
export class UpdateReviewTable1720624462853 implements MigrationInterface {
  name = 'UpdateReviewTable1720624462853';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "review" RENAME COLUMN "reviewerId" TO "userId"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "review" RENAME COLUMN "userId" TO "reviewerId"`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
