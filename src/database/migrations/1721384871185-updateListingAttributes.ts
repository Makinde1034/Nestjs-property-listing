...
export class UpdateListingAttributes1721384871185
  implements MigrationInterface
{
  name = 'UpdateListingAttributes1721384871185';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_f7c0de73fc225af6ae39cc67f9" ON "listing_attributes" ("attributeId") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f7c0de73fc225af6ae39cc67f9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
