...
export class UpdateAdminAddMaximumDaysForOfferExpiration1727424239216
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_default" ADD "maximumDaysForOfferExpiration" integer NOT NULL DEFAULT '2'`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "saiiFee" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-09-27T08:04:00.594Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-09-26 17:29:35.858'`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "saiiFee" SET DEFAULT 0.5`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_default" DROP COLUMN "maximumDaysForOfferExpiration"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
