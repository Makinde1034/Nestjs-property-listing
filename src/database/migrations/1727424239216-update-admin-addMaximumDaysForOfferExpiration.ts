...
export class UpdateAdminAddMaximumDaysForOfferExpiration1727424239216 implements MigrationInterface {
    name = 'UpdateAdminAddMaximumDaysForOfferExpiration1727424239216'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "maximumDaysForOfferExpiration" integer NOT NULL DEFAULT '2'`);
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "saiiFee" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-09-27T08:04:00.594Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-09-26 17:29:35.858'`);
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "saiiFee" SET DEFAULT 0.5`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "maximumDaysForOfferExpiration"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
