...
export class SplashScreenAddTitleAndPlacement1729005661486 implements MigrationInterface {
    name = 'SplashScreenAddTitleAndPlacement1729005661486'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "splash_screen" ADD "title" character varying`);
        await queryRunner.query(`ALTER TABLE "splash_screen" ADD "placement" character varying`);
        await queryRunner.query(`ALTER TABLE "coupon" ADD "currentUse" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-15T15:21:02.859Z"'`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "isBlocked" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "isBlocked" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-15 07:15:01.802'`);
        await queryRunner.query(`ALTER TABLE "coupon" DROP COLUMN "currentUse"`);
        await queryRunner.query(`ALTER TABLE "splash_screen" DROP COLUMN "placement"`);
        await queryRunner.query(`ALTER TABLE "splash_screen" DROP COLUMN "title"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
