...
export class SplashScreenAddTitleAndPlacement1729005661486
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "splash_screen" ADD "title" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "splash_screen" ADD "placement" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "coupon" ADD "currentUse" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-15T15:21:02.859Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ALTER COLUMN "isBlocked" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-15 07:15:01.802'`,
    );
    await queryRunner.query(`ALTER TABLE "coupon" DROP COLUMN "currentUse"`);
    await queryRunner.query(
      `ALTER TABLE "splash_screen" DROP COLUMN "placement"`,
    );
