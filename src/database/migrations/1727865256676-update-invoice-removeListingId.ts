...
export class UpdateInvoiceRemoveListingId1727865256676
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-02T10:34:18.378Z"'`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice" ALTER COLUMN "type" SET DEFAULT 'Saii Fees'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "invoice" ALTER COLUMN "type" SET DEFAULT 'offer'`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-02 09:59:47.188'`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "invoice" ADD "listingid" character varying NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `,
    );
