...
export class UseSnakeCaseForJoinTableInUser1737551605012 implements MigrationInterface {
    name = 'UseSnakeCaseForJoinTableInUser1737551605012'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-01-22T13:13:27.706Z"'`);
