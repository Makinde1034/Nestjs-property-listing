...
export class UpdateAddIsAmmenityToAttributeTable1721050848850
  implements MigrationInterface
{
  name = 'UpdateAddIsAmmenityToAttributeTable1721050848850';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute" ADD "isAmenity" boolean NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "attribute" DROP COLUMN "isAmenity"`);
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
    await queryRunner.query(
