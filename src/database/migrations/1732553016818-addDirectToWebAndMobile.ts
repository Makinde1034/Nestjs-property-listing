...
export class AddDirectToWebAndMobile1732553016818
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "notification_messages" ADD "directToWeb" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification_messages" ADD "directToMobile" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-25T16:43:38.490Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-25 08:03:03.849'`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification_messages" DROP COLUMN "directToMobile"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification_messages" DROP COLUMN "directToWeb"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
