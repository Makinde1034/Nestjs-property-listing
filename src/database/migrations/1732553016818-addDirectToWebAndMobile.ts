...
export class AddDirectToWebAndMobile1732553016818 implements MigrationInterface {
    name = 'AddDirectToWebAndMobile1732553016818'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "notification_messages" ADD "directToWeb" character varying`);
        await queryRunner.query(`ALTER TABLE "notification_messages" ADD "directToMobile" character varying`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-25T16:43:38.490Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-25 08:03:03.849'`);
        await queryRunner.query(`ALTER TABLE "notification_messages" DROP COLUMN "directToMobile"`);
        await queryRunner.query(`ALTER TABLE "notification_messages" DROP COLUMN "directToWeb"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
