...
export class UpdateListingTable1720161467701 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "auction_participant" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "listingId" character varying NOT NULL, "auctionId" uuid, CONSTRAINT "PK_672dbafc4e8f17c0d7f86c6f827" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "maidRoom" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "petAllowed" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "auction_participant" ADD CONSTRAINT "FK_70ae7a8e218266318a7c5d149a4" FOREIGN KEY ("auctionId") REFERENCES "auction"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "auction_participant" DROP CONSTRAINT "FK_70ae7a8e218266318a7c5d149a4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP CONSTRAINT "FK_bfbc9e263d4cea6d7a8c9eb3ad2"`,
    );
