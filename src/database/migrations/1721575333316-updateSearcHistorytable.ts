...
export class UpdateSearcHistorytable1721575333316 implements MigrationInterface {
    name = 'UpdateSearcHistorytable1721575333316'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "numberOfBathrooms" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "userId" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "search_history" ADD CONSTRAINT "FK_11fdc5f9da08d75bbab5296bcd5" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "userId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "numberOfBathrooms" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "search_history" ADD CONSTRAINT "FK_11fdc5f9da08d75bbab5296bcd5" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `);
