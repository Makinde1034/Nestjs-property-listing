...
export class ServiceProvided1732201188513 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-21T14:59:49.980Z"'`);
        ...
        await queryRunner.query(`ALTER TABLE "service_provided" ADD CONSTRAINT "FK_0d46665dc7d1b388dd0d069e80f" FOREIGN KEY ("serviceProviderId") REFERENCES "service_provider"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_provided" ADD CONSTRAINT "FK_88637db335764edd00cef61d408" FOREIGN KEY ("serviceId") REFERENCES "service"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "service_provided" DROP CONSTRAINT "FK_88637db335764edd00cef61d408"`);
        await queryRunner.query(`ALTER TABLE "service_provided" DROP CONSTRAINT "FK_0d46665dc7d1b388dd0d069e80f"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-19 14:32:55.089'`);
        await queryRunner.query(`ALTER TABLE "listing" DROP COLUMN "serviceRequestedId"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`DROP INDEX "public"."IDX_be55b6881355659279926a0990"`);
        await queryRunner.query(`DROP TABLE "service_provided"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e51416b88481b2369d7f3c70be"`);
