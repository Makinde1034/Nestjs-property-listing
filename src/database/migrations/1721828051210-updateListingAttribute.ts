...
export class UpdateListingAttribute1721828051210 implements MigrationInterface {
    name = 'UpdateListingAttribute1721828051210'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "listing" ADD "price" numeric(10,2) NOT NULL DEFAULT '909090'`);
