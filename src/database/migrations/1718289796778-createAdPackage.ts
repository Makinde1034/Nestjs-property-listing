...
export class CreateAdPackage1718289796778 implements MigrationInterface {
  name = 'CreateAdPackage1718289796778';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" ALTER COLUMN "impressions" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ALTER COLUMN "impressions" SET DEFAULT '0'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" ALTER COLUMN "impressions" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ALTER COLUMN "impressions" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
