...
export class AddIndexingToticket1737650367929 implements MigrationInterface {
    name = 'AddIndexingToticket1737650367929'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-01-23T16:39:29.944Z"'`);
        await queryRunner.query(`CREATE INDEX "IDX_aa409ffda4d28635d283090a46" ON "ticket" ("reporterId") `);
        await queryRunner.query(`CREATE INDEX "IDX_303f92942f2c0c65dab0e37eee" ON "ticket" ("parentIssueId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0b270763ea5b764fadaebc1156" ON "ticket" ("childIssueId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0b270763ea5b764fadaebc1156"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_303f92942f2c0c65dab0e37eee"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_aa409ffda4d28635d283090a46"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2025-01-22 10:36:17.739'`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
