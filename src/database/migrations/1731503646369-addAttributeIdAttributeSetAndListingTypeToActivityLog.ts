...
export class AddAttributeIdAttributeSetAndListingTypeToActivityLog1731503646369
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_99cf05a96c3aaf7dfd10b5740d" ON "notification_token" ("id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "activity_log" ADD "attributeId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "activity_log" ADD "attributeSetId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-13T13:14:07.712Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-12 15:17:42.869'`,
    );
    await queryRunner.query(
      `ALTER TABLE "activity_log" DROP COLUMN "attributeSetId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "activity_log" DROP COLUMN "attributeId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_99cf05a96c3aaf7dfd10b5740d"`,
    );
