...
export class AddAttributeIdAttributeSetAndListingTypeToActivityLog1731503646369 implements MigrationInterface {
    name = 'AddAttributeIdAttributeSetAndListingTypeToActivityLog1731503646369'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "notification_token" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "deviceType" character varying NOT NULL, "token" character varying NOT NULL, "status" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_99cf05a96c3aaf7dfd10b5740d0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_99cf05a96c3aaf7dfd10b5740d" ON "notification_token" ("id") `);
        ...
        await queryRunner.query(`ALTER TABLE "activity_log" ADD "attributeId" character varying`);
        await queryRunner.query(`ALTER TABLE "activity_log" ADD "attributeSetId" character varying`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-13T13:14:07.712Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-12 15:17:42.869'`);
        await queryRunner.query(`ALTER TABLE "activity_log" DROP COLUMN "attributeSetId"`);
        await queryRunner.query(`ALTER TABLE "activity_log" DROP COLUMN "attributeId"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`DROP INDEX "public"."IDX_99cf05a96c3aaf7dfd10b5740d"`);
