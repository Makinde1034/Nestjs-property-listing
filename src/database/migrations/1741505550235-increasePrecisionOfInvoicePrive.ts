...
export class IncreasePrecisionOfInvoicePrive1741505550235 implements MigrationInterface {
    name = 'IncreasePrecisionOfInvoicePrive1741505550235'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "invoice" ALTER COLUMN "price" TYPE numeric(17,2)`);
        await queryRunner.query(`ALTER TABLE "invoice" ALTER COLUMN "capturedPrice" TYPE numeric(17,2)`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-03-09T07:32:33.658Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2025-03-04 23:04:08.43'`);
        await queryRunner.query(`ALTER TABLE "invoice" ALTER COLUMN "capturedPrice" TYPE numeric(10,2)`);
        await queryRunner.query(`ALTER TABLE "invoice" ALTER COLUMN "price" TYPE numeric(10,2)`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
