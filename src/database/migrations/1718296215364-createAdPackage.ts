...
export class CreateAdPackage1718296215364 implements MigrationInterface {
  name = 'CreateAdPackage1718296215364';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "promotion" ADD "expiredAt" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "promotion" DROP CONSTRAINT "FK_ef0aaddc6b17269357cdb6815aa"`,
    );
    await queryRunner.query(
      `ALTER TABLE "promotion" DROP CONSTRAINT "REL_ef0aaddc6b17269357cdb6815a"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "promotion" ADD CONSTRAINT "FK_ef0aaddc6b17269357cdb6815aa" FOREIGN KEY ("adPackageId") REFERENCES "ad_package"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "promotion" ADD CONSTRAINT "REL_ef0aaddc6b17269357cdb6815a" UNIQUE ("adPackageId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "promotion" ADD CONSTRAINT "FK_ef0aaddc6b17269357cdb6815aa" FOREIGN KEY ("adPackageId") REFERENCES "ad_package"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(`ALTER TABLE "promotion" DROP COLUMN "expiredAt"`);
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
    await queryRunner.query(
