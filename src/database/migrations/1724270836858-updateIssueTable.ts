...
export class UpdateIssueTable1724270836858 implements MigrationInterface {
  name = 'UpdateIssueTable1724270836858';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "child_issue" ADD "deletedAt" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "parent_issue" ADD "deletedAt" TIMESTAMP`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "parent_issue" DROP COLUMN "deletedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "child_issue" DROP COLUMN "deletedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
