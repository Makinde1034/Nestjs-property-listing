...
export class UpdateListingTable1725404898291 implements MigrationInterface {
    name = 'UpdateListingTable1725404898291'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "listing" ADD "promotionPrice" integer`);
        await queryRunner.query(`ALTER TABLE "listing" ADD "bundleType" character varying`);
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "status" SET DEFAULT 'active'`);
        await queryRunner.query(`ALTER TABLE "ad_package" DROP COLUMN "price"`);
        await queryRunner.query(`ALTER TABLE "ad_package" ADD "price" integer NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ad_package" DROP COLUMN "price"`);
        await queryRunner.query(`ALTER TABLE "ad_package" ADD "price" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "status" SET DEFAULT 'inactive'`);
        await queryRunner.query(`ALTER TABLE "listing" DROP COLUMN "bundleType"`);
        await queryRunner.query(`ALTER TABLE "listing" DROP COLUMN "promotionPrice"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`CREATE INDEX "IDX_bfbc9e263d4cea6d7a8c9eb3ad" ON "role_permissions_permission" ("permissionId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b36cb2e04bc353ca4ede00d87b" ON "role_permissions_permission" ("roleId") `);
