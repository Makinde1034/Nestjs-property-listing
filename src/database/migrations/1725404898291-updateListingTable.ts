...
export class UpdateListingTable1725404898291 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "promotionPrice" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "bundleType" character varying`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "ad_package" ADD "price" integer NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "ad_package" DROP COLUMN "price"`);
    await queryRunner.query(
      `ALTER TABLE "ad_package" ADD "price" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "status" SET DEFAULT 'inactive'`,
    );
    await queryRunner.query(`ALTER TABLE "listing" DROP COLUMN "bundleType"`);
    await queryRunner.query(
      `ALTER TABLE "listing" DROP COLUMN "promotionPrice"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
