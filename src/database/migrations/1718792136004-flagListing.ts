...
export class FlagListing1718792136004 implements MigrationInterface {
  name = 'FlagListing1718792136004';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "flag_listing" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "listingId" uuid NOT NULL, "inappropriate" boolean NOT NULL, "falseInformation" boolean NOT NULL, "userId" character varying NOT NULL, "description" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cd39e70214a4ef1c651a8dc604f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "isListingFlagged" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "disableListing" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing" DROP COLUMN "disableListing"`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing" DROP COLUMN "isListingFlagged"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`,
    );
