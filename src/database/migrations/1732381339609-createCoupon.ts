...
export class CreateCoupon1732381339609 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "coupon" ADD "name" character varying`);
        await queryRunner.query(`ALTER TABLE "coupon" ADD "appliedTo" character varying`);
        await queryRunner.query(`ALTER TABLE "coupon" ADD "type" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "coupon" ADD "usage" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-23T17:02:21.026Z"'`);
        await queryRunner.query(`ALTER TABLE "article" ALTER COLUMN "deletedAt" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "article" ALTER COLUMN "deletedAt" DROP DEFAULT`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "article" ALTER COLUMN "deletedAt" SET DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "article" ALTER COLUMN "deletedAt" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-23 15:11:42.586'`);
