...
export class CreateCoupon1732381339609 implements MigrationInterface {
  name = 'CreateCoupon1732381339609';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "coupon" ADD "name" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "coupon" ADD "appliedTo" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "coupon" ADD "type" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "coupon" ADD "usage" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-23T17:02:21.026Z"'`,
    );
    await queryRunner.query(
      `ALTER TABLE "article" ALTER COLUMN "deletedAt" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "article" ALTER COLUMN "deletedAt" DROP DEFAULT`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "article" ALTER COLUMN "deletedAt" SET DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "article" ALTER COLUMN "deletedAt" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-23 15:11:42.586'`,
    );
    await queryRunner.query(`ALTER TABLE "coupon" DROP COLUMN "usage"`);
    await queryRunner.query(`ALTER TABLE "coupon" DROP COLUMN "type"`);
    await queryRunner.query(`ALTER TABLE "coupon" DROP COLUMN "appliedTo"`);
    await queryRunner.query(`ALTER TABLE "coupon" DROP COLUMN "name"`);
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
    await queryRunner.query(
