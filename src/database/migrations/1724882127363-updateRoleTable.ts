...
export class UpdateRoleTable1724882127363 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "role" ADD "englishName" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "role" ADD "arabicName" character varying`);
