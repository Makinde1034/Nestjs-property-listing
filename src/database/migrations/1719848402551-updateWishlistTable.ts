...
export class UpdateWishlistTable1719848402551 implements MigrationInterface {
  name = 'UpdateWishlistTable1719848402551';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "wishlist" DROP CONSTRAINT "REL_f6eeb74a295e2aad03b76b0ba8"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "wishlist" ADD CONSTRAINT "REL_f6eeb74a295e2aad03b76b0ba8" UNIQUE ("userId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "wishlist" ADD CONSTRAINT "FK_f6eeb74a295e2aad03b76b0ba87" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
