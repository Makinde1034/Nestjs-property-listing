...
export class UpdateAuctionstartTimestamp1738152962602 implements MigrationInterface {
    name = 'UpdateAuctionstartTimestamp1738152962602'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-01-29T12:16:04.378Z"'`);
