...
export class UpdateAdminDefault1726746864866 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_default" ADD "vat" numeric NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "vat"`);
    await queryRunner.query(
      `ALTER TABLE "admin_default" ADD "vat" integer NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "saii"`);
    await queryRunner.query(
      `ALTER TABLE "admin_default" ADD "saii" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
