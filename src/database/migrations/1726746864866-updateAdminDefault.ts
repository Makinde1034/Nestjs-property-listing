...
export class UpdateAdminDefault1726746864866 implements MigrationInterface {
    name = 'UpdateAdminDefault1726746864866'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "vat"`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "vat" numeric NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "vat"`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "vat" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "saii"`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "saii" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
