...
export class UpdateSearcHistorytable1721574486268
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "search_history" ALTER COLUMN "location" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "search_history" ALTER COLUMN "price" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "search_history" ALTER COLUMN "numberOfRooms" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "search_history" ALTER COLUMN "type" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "search_history" ALTER COLUMN "type" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "search_history" ALTER COLUMN "numberOfRooms" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "search_history" ALTER COLUMN "price" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "search_history" ALTER COLUMN "location" SET NOT NULL`,
    );
    await queryRunner.query(
