...
export class UpdateSearcHistorytable1721574486268 implements MigrationInterface {
    name = 'UpdateSearcHistorytable1721574486268'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "location" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "price" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "numberOfRooms" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "type" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "type" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "numberOfRooms" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "price" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "search_history" ALTER COLUMN "location" SET NOT NULL`);
