...
export class UpdateListingAttributes1721383542668
  implements MigrationInterface
{
  name = 'UpdateListingAttributes1721383542668';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing_attributes" ALTER COLUMN "listingId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing_attributes" DROP COLUMN "attributeId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing_attributes" ADD "attributeId" uuid`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listing_attributes" ALTER COLUMN "listingId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "listing_attributes" ADD CONSTRAINT "FK_2c3503e6ed6c50af820d3f938df" FOREIGN KEY ("listingId") REFERENCES "listing"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
