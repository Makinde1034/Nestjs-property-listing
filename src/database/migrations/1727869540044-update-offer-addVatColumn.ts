...
export class UpdateOfferAddVatColumn1727869540044
  implements MigrationInterface
{
  name = 'UpdateOfferAddVatColumn1727869540044';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "offer" ADD "vat" numeric(12,2) NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "price" TYPE numeric(12,2)`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "price" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "saiiFee" TYPE numeric(12,2)`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-02T11:45:42.124Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-02 10:34:18.378'`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "saiiFee" TYPE numeric(10,2)`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "price" SET DEFAULT '1300'`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer" ALTER COLUMN "price" TYPE numeric(10,2)`,
    );
    await queryRunner.query(`ALTER TABLE "offer" DROP COLUMN "vat"`);
    await queryRunner.query(
      `ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`,
    );
    await queryRunner.query(
