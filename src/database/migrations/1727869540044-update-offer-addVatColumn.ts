...
export class UpdateOfferAddVatColumn1727869540044 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "offer" ADD "vat" numeric(12,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "price" TYPE numeric(12,2)`);
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "price" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "saiiFee" TYPE numeric(12,2)`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-10-02T11:45:42.124Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-10-02 10:34:18.378'`);
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "saiiFee" TYPE numeric(10,2)`);
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "price" SET DEFAULT '1300'`);
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "price" TYPE numeric(10,2)`);
