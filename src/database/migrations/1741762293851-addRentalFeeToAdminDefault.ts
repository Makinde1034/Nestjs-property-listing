...
export class AddRentalFeeToAdminDefault1741762293851 implements MigrationInterface {
    name = 'AddRentalFeeToAdminDefault1741762293851'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "rentalFee" integer NOT NULL DEFAULT '5000'`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-03-12T06:51:39.233Z"'`);
        await queryRunner.query(`ALTER TABLE "service_provided" ALTER COLUMN "coverageArea" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "service_provided" ALTER COLUMN "coverageArea" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "user_tracking" ALTER COLUMN "userAgent" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "user_tracking" ALTER COLUMN "userAgent" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "service_provided" ALTER COLUMN "coverageArea" SET DEFAULT 'Riyadh'`);
        await queryRunner.query(`ALTER TABLE "service_provided" ALTER COLUMN "coverageArea" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2025-03-10 16:25:10.173'`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "rentalFee"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
