...
export class NotificationMessage1731876770986 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "promptRatingTime" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "saiiFromSale" numeric NOT NULL`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "saiiForRent" numeric NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2024-11-17T20:52:53.151Z"'`);
        await queryRunner.query(`ALTER TABLE "admin_default" ALTER COLUMN "ticketAging" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "admin_default" ALTER COLUMN "ticketAging" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2024-11-15 14:12:01.565'`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "saiiForRent"`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "saiiFromSale"`);
        await queryRunner.query(`ALTER TABLE "admin_default" DROP COLUMN "promptRatingTime"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "use"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" DROP COLUMN "approve"`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "approve" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "role_permissions_permission" ADD "use" boolean DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "admin_default" ADD "saii" numeric NOT NULL`);
        await queryRunner.query(`DROP INDEX "public"."IDX_025a03ac35a495f0a6d8730350"`);
