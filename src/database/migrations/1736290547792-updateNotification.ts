...
export class UpdateNotification1736290547792 implements MigrationInterface {
    name = 'UpdateNotification1736290547792'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "notification" ADD "metadata" character varying`);
        await queryRunner.query(`ALTER TABLE "notification" ADD "category" character varying`);
        await queryRunner.query(`ALTER TABLE "notification" ADD "subCategory" character varying`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-01-07T22:55:49.617Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bfbc9e263d4cea6d7a8c9eb3ad"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b36cb2e04bc353ca4ede00d87b"`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '2025-01-07 21:01:29.548'`);
        await queryRunner.query(`ALTER TABLE "notification" DROP COLUMN "subCategory"`);
