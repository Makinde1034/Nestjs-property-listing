...
export class ServiceProviderForCustomer1742458542071 implements MigrationInterface {
    name = 'ServiceProviderForCustomer1742458542071'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "service_provider" ADD "firstName" character varying`);
        await queryRunner.query(`ALTER TABLE "service_provider" ADD "lastName" character varying`);
        await queryRunner.query(`ALTER TABLE "invoice" ALTER COLUMN "checkoutId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "invoice" ALTER COLUMN "checkoutId" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "updatedAt" SET DEFAULT '"2025-03-20T08:15:44.127Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "invoice" ALTER COLUMN "checkoutId" SET DEFAULT ''`);
        await queryRunner.query(`ALTER TABLE "invoice" ALTER COLUMN "checkoutId" SET NOT NULL`);
